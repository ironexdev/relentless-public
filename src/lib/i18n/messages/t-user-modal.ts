...
export function t_user_email_error(locale: LocaleType): string {
	const messages = {
		en: 'Something went wrong. Please try again later.',
		cs: 'Něco se pokazilo. Zkus to prosím později.'
	};
...
export function t_user_email_step_two_pin_label(locale: LocaleType): string {
	const messages = {
		en: 'PIN FROM CURRENT E-MAIL',
		cs: 'PIN ZE STÁVAJÍCÍHO E-MAILU'
	};
